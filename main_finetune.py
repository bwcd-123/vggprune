...
def save_checkpoint(state, is_best, filepath):
    torch.save(state, os.path.join(filepath, 'finetune_checkpoint.pth.tar'))
    if is_best:
        shutil.copyfile(os.path.join(filepath, 'finetune_checkpoint.pth.tar'), os.path.join(filepath, 'finetune_model_best.pth.tar'))
